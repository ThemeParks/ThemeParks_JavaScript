...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Themeparks.EntityScheduleResponse();
  });
  ...
  describe('EntityScheduleResponse', function() {
    it('should create an instance of EntityScheduleResponse', function() {
      // uncomment below and update the code to test EntityScheduleResponse
      //var instance = new Themeparks.EntityScheduleResponse();
      //expect(instance).to.be.a(Themeparks.EntityScheduleResponse);
    });
